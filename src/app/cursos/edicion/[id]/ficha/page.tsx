  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 print:py-4 print:px-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm font-medium text-gray-600 mt-0.5">Ficha — {edicion.name}</p>
      ...
      {(t.horas_clases || t.horas_practica || t.dias_terreno) && (
        <div className="grid grid-cols-3 sm:grid-cols-5 gap-4 p-4 bg-gray-50 rounded-xl mb-6 text-center">
      ...
      {hasCurriculum ? (
        ...
        <div className="p-6 bg-gray-50 border border-gray-200 rounded-xl mb-6 text-center">
          <p className="text-sm text-gray-500">El coordinador aún no ha ingresado el contenido de este taller.</p>
        </div>
      )}
      ...
      {(t.equipo_personal || t.equipo_recomendado || t.equipo_cau) && (
        <div className="bg-white border border-gray-200 rounded-xl p-5 mb-6">
          <h2 className="text-sm font-bold text-gray-700 uppercase tracking-wide mb-3">Equipamiento</h2>
          <dl>
      ...
      {(t.bibliografia || t.observaciones) && (
        <div className="bg-white border border-gray-200 rounded-xl p-5 mb-6">
          <h2 className="text-sm font-bold text-gray-700 uppercase tracking-wide mb-3">Referencias</h2>
          <dl>
