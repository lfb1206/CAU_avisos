        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-4 p-3 bg-gray-50 rounded-lg text-sm">
              <div><span className="text-gray-500">Inicio:</span> <strong>{fmtDate(edicion.start_date)}</strong></div>
              <div><span className="text-gray-500">Fin:</span> <strong>{fmtDate(edicion.end_date)}</strong></div>
              <div><span className="text-gray-500">Cupos:</span> <strong>{edicion.capacity}</strong></div>
              <div><span className="text-gray-500">Inscritos:</span> <strong>{edicion.inscripciones.length}</strong></div>
            </div>
